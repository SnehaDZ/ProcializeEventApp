...
import com.procialize.eventsapp.util.DisplayUtil;
...
public class RoundedBoard {
    ...
    static final int WIDTH = 7 * Emotion.MEDIUM_SIZE + 8 * Constants.HORIZONTAL_SPACING;
...
//  static final float BOTTOM = 1300;
    ...
    void draw(Canvas canvas) {
        rect.set(LEFT, y, LEFT + WIDTH + 10, y + height);
