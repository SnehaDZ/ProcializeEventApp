...
public class VisitUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(VisitUsersActivity.this);
    ...
    public void ExhibitorViewUserListing(String event_id, String token, String exhibitor_id) {
        mAPIService.ExhibitorViewUserListing(token, event_id, exhibitor_id).enqueue(new Callback<ExhibitorViewUserListing>() {
            @Override
            public void onResponse(Call<ExhibitorViewUserListing> call, Response<ExhibitorViewUserListing> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getMsg().equalsIgnoreCase("Invalid Token!")) {
                        Intent main = new Intent(VisitUsersActivity.this, LoginActivity.class);
                        startActivity(main);
                        finish();

                    } else {
                        adapter = new VisitUserAdapter(VisitUsersActivity.this, response.body().getExhibitor_view_user_list());
            ...
            @Override
            public void onFailure(Call<ExhibitorViewUserListing> call, Throwable t) {
                Toast.makeText(VisitUsersActivity.this, "Low network or no network", Toast.LENGTH_SHORT).show();
